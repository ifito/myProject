...
export class UserService implements OnDestroy {
  ...
  register(username: string, email: string, password: string, rePass: string, tel: string) {

    return this.http.post<User>('/api/register', { username, email, password, rePass, tel })
